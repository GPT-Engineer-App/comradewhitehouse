...
const FeaturesSection = () => (
  <section className="py-16 bg-gray-100">
    <div className="container mx-auto">
      <h2 className="text-3xl font-bold text-center mb-12">The People's Priorities</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <FeatureCard
          icon={Star}
          title="Equality for All"
          description="Ensuring every comrade has equal rights and opportunities in our society."
        />
        <FeatureCard
          icon={Users}
          title="Collective Ownership"
          description="Promoting shared ownership of the means of production for the benefit of all."
        />
        <FeatureCard
          icon={Calendar}
          title="Five-Year Plans"
          description="Implementing strategic economic plans to advance our nation's prosperity."
        />
      </div>
    </div>
  </section>
...
const Footer = () => (
  <footer className="bg-red-800 text-white py-8">
    <div className="container mx-auto text-center">
      <p>&copy; 2024 People's White House. All rights belong to the people.</p>
    </div>
  </footer>
);
